...
def eval(output_folder, gt_folder):
    ...
    similarity_list = []
    # Change you path: the .txt file of V2C setting2
    with open(
            "/data/conggaoxiang/6_PAMI/1_Stage_E1/DiffGAN-TTS_V2C_RealHiFiGAN/preprocessed_data/V2C_Diff/Refrence_Setting2.txt", 
            "r",
             encoding="utf-8"
        ) as f:
