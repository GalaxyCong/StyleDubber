...
from dataset import Dataset_denoise2
...
def evaluate_test_allinference(model, fusion_model, step, configs, vocoder, val_samples_path):
    ...
    val_set = "Refrence_Setting2.txt"
    dataset = Dataset_denoise2(
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', default='0_Cemara_Setting2/{}'.format(aim.split('/')[-1]))
